...
@Component({
  ...
  template: `<div class="container-fluid m-0 p-0">
    <section id="layout">
      ...
      <div class="content image"><img alt="error" class="errorImage" src="assets/images/apv/504_error.svg" /></div>
      <div class="content error-title">{{ 'ERRORS.504_TITLE' | translate }}</div>
      <div class="content error-text">
        <p class="text">{{ 'ERRORS.504_DESCRIPTION' | translate }}</p>
      </div>
...
export class ApvGatewayTimeoutComponent {}
