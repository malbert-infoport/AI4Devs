...
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'Helix6_Test', @level1type = N'VIEW', @level1name = N'VTA_Worker';
...
Begin DesignProperties = 
   ...
   Begin DiagramPane = 
      ...
      End
      Begin Tables = 
         Begin Table = "Worker (Helix6_Test)"
            Begin Extent = 
               Top = 6
               Left = 38
               Bottom = 136
            ...
            TopColumn = 0
         End
         Begin Table = "WorkerType (Helix6_Test)"
            Begin Extent = 
               Top = 138
               Left = 38
               Bottom = 268
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'Helix6_Test', @level1type = N'VIEW', @level1name = N'VTA_Worker';
