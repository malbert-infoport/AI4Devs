...
SELECT nid, nid, 'Acme Logistics S.L.', 'ACME', 'B12345678', 'C/ Comercio 12', 'Madrid', '28001', 'Spain', 'info@acmelogistics.com', '+34 912 345 678', NULL, 1, NOW(), 1, NOW()
FROM next_id
...
SELECT nid, nid, 'Iberia Transportes S.A.', 'IBER', 'A87654321', 'Av. de la Marina 45', 'Barcelona', '08001', 'Spain', 'contact@iberiatrans.es', '+34 934 567 890', NULL, 1, NOW(), 1, NOW()
FROM next_id
...
SELECT nid, nid, 'TransMar Logistics SL', 'TRMS', 'B23456789', 'C/ Puerto 7', 'Valencia', '46001', 'Spain', 'ops@transmar.es', '+34 911 223 344', (SELECT "Id" FROM grp), 1, NOW(), 1, NOW()
FROM next_id
...
SELECT nid, nid, 'NovaCargo S.L.', 'NOVC', 'B98765432', 'C/ Nave 3', 'Seville', '41001', 'Spain', 'hello@novacargo.com', '+34 900 111 222', (SELECT "Id" FROM grp), 1, NOW(), 1, NOW()
FROM next_id
...
SELECT nid, nid, 'Grupo Oeste S.A.', 'GOST', 'A11223344', 'Paseo Oeste 21', 'Seville', '41002', 'Spain', 'info@grupo-oeste.es', '+34 955 332 211', NULL, 1, NOW(), 1, NOW()
FROM next_id
...
SELECT nid, nid, 'Alpine Freight GmbH', 'ALPF', 'DE123456789', 'Berliner Str. 10', 'Berlin', '10115', 'Germany', 'contact@alpinefreight.de', '+49 30 1234567', NULL, 1, NOW(), 1, NOW()
FROM next_id
...
SELECT nid, nid, 'Old Freight S.L.', 'OLDF', 'B00000000', 'C/ Vieja 1', 'Cadiz', '11001', 'Spain', 'noreply@oldfreight.es', '+34 900 000 000', NULL, 1, NOW(), 1, NOW(), NOW()
FROM next_id
