...
{
	[MetadataType(typeof(AttachmentViewMetadata))]
    public partial class AttachmentView : IViewBase
	{
		[Key]
		...
		public AttachmentFileView AttachmentFile { get; set; }

		[ForeignKey("AttachmentTypeId")]
		[InverseProperty("Attachment")]
		public AttachmentTypeView AttachmentType { get; set; }
	}
}
