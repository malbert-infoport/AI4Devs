...
{
    [MetadataType(typeof(SecurityUserGridConfigurationViewMetadata))]
    public partial class SecurityUserGridConfigurationView: IViewBase	
	{
		[Key]
		...
		public Boolean DefaultConfiguration { get; set; }
		...
		public SecurityUserView SecurityUser { get; set; }
	}
}
