...
namespace __NAMESPACE__
{
    public class __ENTITY_NAME__Service : __BASE_SERVICE__
    {
        ...
        // Versioned-entity specific overrides can be placed here
            ...
            string? configurationName = null)
        {
            if (view != null)
            {
                // TODO: Validate version constraints (VersionKey/VersionNumber)
            }
        ...
        public override async Task PreviousActions(
            ...
            string? configurationName = null)
        {
            // TODO: handle versioning business rules before persistence
