...
@Component({
  selector: 'apv-not-found',
  template: `
    <div class="container-fluid m-0 p-0">
      <section id="layout">
        <div class="content logo"><img alt="logo" class="logoImage" src="assets/images/apv/logoApv.svg" /></div>
        <div class="content image"><img alt="error" class="errorImage" src="assets/images/apv/404_error.svg" /></div>
        <div class="content error-title">{{ 'ERRORS.404_TITLE' | translate }}</div>
        <div class="content error-text">
          <p class="text">{{ 'ERRORS.404_DESCRIPTION' | translate }}</p>
        </div>
...
export class ApvNotFoundComponent {}
